"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[618],{27575:(e,t,n)=>{n.d(t,{YE:()=>$,bf:()=>v,yr:()=>l});var r=n(28776),i=n(18765),o=n(92394);let{getBroadcastDims:a}=r.backend_util;function l(e,t,n){let l,C;let T=[];if(e.forEach(e=>{let t=r.util.sizeFromShape(e.shapeInfo.logicalShape);if(e.shapeInfo.isUniform?T.push(`uniform float ${e.name}${t>1?`[${t}]`:""};`):(T.push(`uniform sampler2D ${e.name};`),T.push(`uniform int offset${e.name};`)),n.enableShapeUniforms){let{uniformShape:t}=$(n.packedInputs,e.shapeInfo.logicalShape,e.shapeInfo.texShape);switch(t.length){case 1:T.push(`uniform int ${e.name}Shape;`);break;case 2:T.push(`uniform ivec2 ${e.name}Shape;`);break;case 3:T.push(`uniform ivec3 ${e.name}Shape;`);break;case 4:T.push(`uniform ivec4 ${e.name}Shape;`)}T.push(`uniform ivec2 ${e.name}TexShape;`)}}),n.enableShapeUniforms){switch(t.logicalShape.length){case 1:T.push("uniform int outShape;");break;case 2:T.push("uniform ivec2 outShape;"),T.push("uniform int outShapeStrides;");break;case 3:T.push("uniform ivec3 outShape;"),T.push("uniform ivec2 outShapeStrides;");break;case 4:T.push("uniform ivec4 outShape;"),T.push("uniform ivec3 outShapeStrides;")}T.push("uniform ivec2 outTexShape;")}n.customUniforms&&n.customUniforms.forEach(e=>{T.push(`uniform ${e.type} ${e.name}${e.arrayIndex?`[${e.arrayIndex}]`:""};`)});let m=T.join("\n"),R=e.map(e=>(function(e,t,n=!1,o){let l="";n?l+=function e(t,n){switch(t.shapeInfo.logicalShape.length){case 0:return function(e){let t=e.name,n="get"+t.charAt(0).toUpperCase()+t.slice(1),r=(0,i.B)();return`
  ...
  `}(t,n);case 2:return function(e,t){let n=e.shapeInfo.logicalShape,o=e.name,a="get"+o.charAt(0).toUpperCase()+o.slice(1),l=e.shapeInfo.texShape,u=l[0],c=l[1],p=(0,i.B)();if(null!=l&&r.util.arraysEqual(n,l))return t?`
